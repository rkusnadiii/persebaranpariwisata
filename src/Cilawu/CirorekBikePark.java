...
public class CirorekBikePark {
	
public CirorekBikePark() {
...
public void frame() {
	...
	JTextArea area = new JTextArea (" Desa : Kampung Cirorek \n Kecamatan : Cilawu \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 11,7 KM ");
	JTextArea area2 = new JTextArea ("-");
	JTextArea area3 = new JTextArea ("Cirorek Bike Park dapat ditempuh menggunakan kendaraan pribadi. Jalur menuju Cirorek Bike Park melalui Jalan Raya Garut-Tasikmalaya. Waktu tempuh perjalanan dari pusat kota (Alun-Alun Garut) selama 30 menit. Kondisi jalan menuju Cirorek Bike Park masih harus diperbaiki karena jalan yang masih menggunakan batu dan tanah.");
	JTextArea area4 = new JTextArea ("Area downhill dan hutan pinus.");
	JTextArea area5 = new JTextArea ("Warung dan tempat sampah");
