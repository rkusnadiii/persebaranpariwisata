...
public class CurugCihanyawar extends JFrame{
	
	
	
public CurugCihanyawar() {
...
public void frame() {
	...
	JTextArea area = new JTextArea (" Desa : Sukamurni \n Kecamatan : Cilawu \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 17,8 Km");
	JTextArea area2 = new JTextArea ("±3ha");
	JTextArea area3 = new JTextArea ("Curug Cihanyawar dapat diakses menggunakan kendaraan pribadi. Jalur yang dilalui yaitu Jalan Raya Garut-Tasikmalaya, menuju Jalan Cipeuteuy. Kondisi jalan cukup baik, namun untuk Jalan Cipeuteuy masih perlu perbaikan. Perjalanan dapat ditempuh selama 37 menit (dari Alun-Alun Garut).");
	JTextArea area4 = new JTextArea ("Air Terjun, Hutan Pinus, Perkebunan teh");
	JTextArea area5 = new JTextArea ("Toilet, mushola, gazebo, tempat sampah dan tempat parkir.");
	...
	//frame
			...
			//label6
					label6.setText("CurugCihanyawar");
			...
			//label14
					label14.setText("Tiket Masuk : Rp 10.000/orang, Rp 2000/Motor, Rp 5000/mobil");
