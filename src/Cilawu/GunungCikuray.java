...
public class GunungCikuray extends JFrame {
	
	
public GunungCikuray() {
...
public void frame() {
	...
	JTextArea area = new JTextArea (" Desa : Dangiang (Pamancar) \n Kecamatan : Cilawu \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 14,7 Km");
	JTextArea area2 = new JTextArea ("2821 mdpl");
	JTextArea area3 = new JTextArea ("Melalui Jalan Raya Garut-Tasikmalaya dan masuk ke gapura biru (Patrol). Kondisi jalan sangat baik namun pada jalan desa hanya berupa batu dan tanah. Perjalanan dapat ditempuh menggunakan mobil pribadi dengan waktu tempuh 47 menit dari Alun-Alun Garut untuk sampai di Pamancar.");
	JTextArea area4 = new JTextArea ("Gunung tertinggi di Kabupaten Garut, panorama samudra awan di atas puncak dan hamparan kebun teh.");
	JTextArea area5 = new JTextArea ("Warung, toilet, tempat sampah, pos pendaftaran, area parkir dan P3K.");
	...
	//frame
			...
			//label8
					label8.setText("Perum Perhutani KPH Kab. Garut ");
			...
			//label14
					label14.setText("Tiket Masuk : 25.000/orang");
