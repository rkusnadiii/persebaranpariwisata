...
public class DayeuhManggung extends JFrame{
	
	
	public DayeuhManggung() {
...
public void frame() {
	//icon
			...
			JTextArea area = new JTextArea (" Desa : Dayeuh Manggung \n Kecamatan : Cilawu \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 15 Km");
			JTextArea area2 = new JTextArea ("±10ha");
			JTextArea area3 = new JTextArea ("Dayeuh Wisata Dayeuh Manggung dapat diakses menggunakan kendaraan pribadi serta kendaraan umum berupa ojek. Akses menuju lokasi ditempuh melalui Jalan Raya Garut-Tasikmalaya dengan waktu tempuh 29 menit dari pusat kota (Alun-Alun Garut). Kondisi jalan sangat baik, namun di dalam destinasi masih perlunya perbaikan karena jalan hanya berupa bebatuan.");
			JTextArea area4 = new JTextArea ("Hamparan kebun teh, kebun jeruk, keunikan talang air tua dan tiga kampung wisata yaitu Kampung My Darling, Kampung Jokowi serta Kampung Amsterdam");
			JTextArea area5 = new JTextArea ("Mushola, toilet, tempat sampah, warung, gazebo, pos satpam/tiket dan lapangan olahraga.");
			...
			//frame
					...
					//label14
							label14.setText("Tiket Masuk : 5000/orang");
