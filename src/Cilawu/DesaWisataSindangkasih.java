...
public class DesaWisataSindangkasih {
	
public void DesaWisataSindangKasih() {
	...
	public void frame() {
		...
		//icon
				...
				JTextArea area = new JTextArea (" Desa : Kampung Sindangkasih \n Kecamatan : Cilawu \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 15,7 KM Km");
				JTextArea area2 = new JTextArea ("±5ha");
				JTextArea area3 = new JTextArea ("Desa Wisata Sindangkasih dapat diakses melalui Jalan Raya Garut-Tasikmalaya, letak desa wisata ini disamping jalan utama. Waktu tempuh dari pusat kota (Alun-Alun Garut) selama 29 menit. Desa Wisata Sindangkasih dapat diakses menggunakan kendaraan pribadi dan kendaraan umum. Kondisi jalan sangat baik, namun ada baiknya calon pengunjung untuk berhati-hati karena jalan didominasi oleh berkelok.");
				JTextArea area4 = new JTextArea ("River tubbing, wisata desa dan pemandangan hamparan persawahan.");
				JTextArea area5 = new JTextArea ("Homestay, masjid, aula, toilet, tempat sampah, warung dan alat-alat keselamatan");
				...
				//frame
						...
						//label14
								label14.setText("Tiket Masuk : Rp. 5.000/orang, Rp. 5.000/mobil kecil, Rp. 15.000/mobil besar dan Rp. 2.000/motor");
								label14.setFont(new Font("Arial",Font.PLAIN,16));
								label14.setForeground(new Color(242,110,1));
								label14.setBounds(300,600 ,700, 70);
	...
	public static void main(String[] args) {
		new DesaWisataSindangkasih().frame();
