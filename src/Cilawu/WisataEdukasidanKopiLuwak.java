...
public class WisataEdukasidanKopiLuwak {
	
public WisataEdukasidanKopiLuwak() {
...
public void frame() {
	...
	//icon
		...
		JTextArea area = new JTextArea (" Desa : Cikasong \n Kecamatan : Cilawu \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 8, 6 KM");
		JTextArea area2 = new JTextArea ("800m2");
		JTextArea area3 = new JTextArea ("Wisata Edukasi Kopi dan Luwak dapat diakses melalui Jalan Raya Garut-Tasikmalaya. Perjalanan ditempuh selama 18 menit (dari Alun-Alun Garut). Kondisi jalan sangat baik dan sudah di aspal.");
		JTextArea area4 = new JTextArea ("Pengolahan kopi luwak, peternakan luwak, dan coffeeshop");
		JTextArea area5 = new JTextArea ("Toilet, mushola dan tempat sampah");
	...
	public static void main(String[] args) {
		new WisataEdukasidanKopiLuwak().frame();
