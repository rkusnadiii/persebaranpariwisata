...
public class LapangGolfNgamplang extends JFrame{
	
	
	public LapangGolfNgamplang() {
		...
		JTextArea area = new JTextArea (" Desa : Ngamplang \n Kecamatan : Cilawu \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 5,6 Km");
		JTextArea area2 = new JTextArea ("±10ha");
		JTextArea area3 = new JTextArea ("Lapang Golf Ngamplang bisa diakses menggunakan kendaraan pribadi dan kendaraan umum. Kendaraan umum yang dapat digunakan yaitu angkutan kota dan bus yang melintas di Jalan Raya Garut-Tasikmalaya. Waktu tempuh menuju lokasi dari arah Garut Kota (Alun-Alun Garut) selama 12 menit. Kondisi jalan sangat baik karena termasuk di jalur utama Garut-Tasikmalaya.");
		JTextArea area4 = new JTextArea ("Lapang Golf, Hamparan Lapang Hijau");
		JTextArea area5 = new JTextArea ("Mushola,Toilet,Tempat Sampah,Warung,Gazebo,Area Parkir, Kantor Pengelola, Hotel, Pos Tiket");
		...
		//frame
				...
				//label14
						label14.setText("Tiket Masuk : Rp. 125.000 Hari Senin - Kamis, Rp 150.000 Jumat - Minggu");
						label14.setFont(new Font("Arial",Font.PLAIN,16));
						label14.setForeground(new Color(242,110,1));
						label14.setBounds(400,600 ,700, 70);
