...
public class KebunMawarSituhapa extends JFrame {
	
	public KebunMawarSituhapa() {
 ...
 void frame() {
		...
		JTextArea area = new JTextArea (" Desa : - \n Kecamatan : Samarang \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 11 Km");
		JTextArea area2 = new JTextArea ("±5 Ha");
		JTextArea area3 = new JTextArea ("Infrastruktur jalan dari terminal garut menuju lokasi baik. untuk mencapai ke lokasi dapat menggunakan transportasi berupa angkutan umum jurusan Terminal guntur - Samarang. setelah itu untuk menuju lokasi yang berjarak 2km dari terminal samarang dapat menggunakan kendaraan roda 4 atau angkutan desa, roda dua berupa ojeg");
		JTextArea area4 = new JTextArea ("500 jenis bunga mawar dari dalam maupun luar negeri");
		JTextArea area5 = new JTextArea ("Toilet, Villa, Kantin, Mushola, Sarana Outbond, Gazebo, Tempat Parkir");
		...
		//area3
		area3.setFont(new Font("Arial",Font.PLAIN,11));
		...
		//label6
				label6.setText("Kebun Mawar Situhapa");
		...
		//label8
				label8.setText("Dikelola oleh Manajemen Kebun Mawar Situhapa");
		...
		//label14
				label14.setText("sumber foto: trivindo.com");
