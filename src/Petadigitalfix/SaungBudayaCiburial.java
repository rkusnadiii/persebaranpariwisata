...
public class SaungBudayaCiburial extends JFrame {
	
	public SaungBudayaCiburial() {
	 ...
	 void frame() {
		...
		JTextArea area2 = new JTextArea ("±10 Ha");
		JTextArea area3 = new JTextArea ("Sudah dapat ditempuh memakai angkutan kota jurusan Terminal Guntur Samarang");
		JTextArea area4 = new JTextArea ("Kebun sawi, kolam, atraksi seni tradisional sunda, peternakan domba garut.");
		JTextArea area5 = new JTextArea ("Mushola,Gazebo,Toilet,Villa,\nHomestay,Padepokan Seni,Tempat Parkir, Sarana Outbond,Kios");
