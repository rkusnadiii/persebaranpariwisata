...
public class Cipanas {
    ...
    public void frame( ) {
        ...
        JTextArea area = new JTextArea (" Desa : Rancabango/Cimanganten/Pananjung \n Kecamatan : Tarogong Kaler \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 4 KM ");
        JTextArea area2 = new JTextArea ("30ha");
        JTextArea area3 = new JTextArea ("Dapat Diakses oleh Kendaraan Umum maupun Pribadi.");
        JTextArea area4 = new JTextArea ("Wisata Alam, Wisata Buatan");
