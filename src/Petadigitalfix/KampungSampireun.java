...
public class KampungSampireun extends JFrame {
	
	public KampungSampireun() {
	 ...
	 void frame() {
		...
		JTextArea area = new JTextArea (" Desa : Desa Sukakarya \n Kecamatan : Samarang \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 11 Km");
		JTextArea area2 = new JTextArea ("±5 Ha");
		JTextArea area3 = new JTextArea ("Sudah dilayani oleh angkutan Umum jurusan termnak guntur samarang. infrastuktur jalan kendaraan sampai kota kecamatan samarang beraspal dan hotmik. untuk mencapai ke lokasi dapat menggunakan transportasi angkutan desa dan roda dua berupa ojeg");
		JTextArea area4 = new JTextArea ("Villa, resort berasiktektur sunda, danau, taman");
		JTextArea area5 = new JTextArea ("Sudah sesuai standar dan hotel bintang 3");
		...
		//label6
				label6.setText("Kampung Sampireun");
		...
		//label8
				label8.setText("Dikelola oleh Manajemen Kampung Resort Sampireun");
