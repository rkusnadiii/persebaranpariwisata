...
public class SituCibereum extends JFrame {
	...
	public SituCibereum() {
	 ...
	 void frame() {
		...
		JTextArea area3 = new JTextArea ("Sudah dilayani oleh angkutan Umum jurusan terminal guntur samarang. infrastuktur jalan kendaraan sampai kota kecamatan samarang beraspal dan hotmik. untuk mencapai ke lokasi yang berjarak 5km dapat menggunakan kendaraan roda 4 dan roda 2 berupa ojeg");
		JTextArea area4 = new JTextArea ("Danau dan hutan");
		JTextArea area5 = new JTextArea ("Toilet,Mushola,Cottage,Warung");
		...
		//label8
				label8.setText("Dikelola oleh Warga Lokal");
