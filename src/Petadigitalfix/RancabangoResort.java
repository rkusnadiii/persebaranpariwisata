...
public class RancabangoResort extends JFrame {

    public RancabangoResort() {
    ...
    void frame() {
        ...
        JTextArea area = new JTextArea (" Desa : Rancabango \n Kecamatan : Tarogong Kaler \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 5,2 Km");
        JTextArea area2 = new JTextArea ("3 Ha");
        JTextArea area3 = new JTextArea ("Untuk mencapai Hotel & Resort Rancabango, kita akan memasuki jalan lokal primer yaitu desa Rancabango. Apabila datang dari arah kota Garut, maka masuk desa berada di sebelah kiri jalan raya. Infrastuktur jalan di Jl Rancabango cukup baik. Sudah beraspal dan hotmik. Untuk mencapai ke lokasi dapat menggunakan transportasi angkutan umum online,andong dan kendaraan pribadi. Jalan lokal primer sangan sudah cukup untuk dua mobil. Infrastuktur jalan pedesaannya sedikit berlubang. Banyak sawah, pepohonan di sepanjang jalan.");
        JTextArea area4 = new JTextArea ("View Gunung Guntur");
        JTextArea area5 = new JTextArea ("Toilet,Mushola,Tempat Wudhu, Pintu Masuk, Pos Keamanan, Parkir, Kolam Renang, Tempat Bilas");
        ...
        //label6
        label6.setText("Hotel & Resort RancaBango");
        ...
        //label8
        label8.setText("Dikelola oleh Hj Deden ");
