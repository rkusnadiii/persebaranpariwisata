...
public class MakamImingBunyamin extends JFrame {
	
	public MakamImingBunyamin() {
	 ...
	 void frame() {
		...
		//icon2
				...
				//icon6
				ImageIcon icon6 = new ImageIcon("src/Makam Iming Bunyamin 2.jpeg");
				Image iconrubah6 = icon6.getImage();
				Image modified6 = iconrubah6.getScaledInstance(400,300,900);
				icon6 = new ImageIcon(modified6);
				//icon7
				ImageIcon icon7 = new ImageIcon("src/Makan Iming Bunyamin 1.jpeg");
		...
		JTextArea area = new JTextArea (" Desa : Cintarakyat \n Kecamatan : Samarang \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 9,8 Km");
		JTextArea area2 = new JTextArea ("±1ha");
		JTextArea area3 = new JTextArea ("Untuk mencapai makam iming bunyamin, kita akan memasuki jalan pedesaan yaitu desa Cintarakyat. Apabila datang dari arah kota Garut, maka gapura masuk desa berada di sebelah kiri jalan raya. Infrastuktur jalan di Jl Samarang cukup baik. Sudah beraspal dan hotmik. Untuk mencapai ke lokasi dapat menggunakan transportasi angkutan umum jurusan samarang dan menggunakan ojeg saat memasuki desa. Jalan pedesaan aga kecil namun cukup untuk dua mobil. Infrastuktur jalan pedesaannya cukup berlubang. Banyak sawah, pepohonan, dan perkebunan di sepanjang jalan");
		JTextArea area4 = new JTextArea ("Sejarah dan Ziarah Makam");
		JTextArea area5 = new JTextArea ("Masjid,Toilet");
