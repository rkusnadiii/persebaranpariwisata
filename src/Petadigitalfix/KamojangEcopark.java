...
public class KamojangEcopark extends JFrame {
	
	public KamojangEcopark() {
	 ...
	 void frame() {
		...
		JTextArea area = new JTextArea (" Alamat : Jl Samarang - Kamojang \n Kecamatan : Samarang \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 14 Km");
		...
		JTextArea area4 = new JTextArea ("Venue terbuka di tengah area hutan pinus");
		...
		//label6
				label6.setText("Kamojang Eco Park");
