...
public class Gunungputri extends JFrame {
...
public Gunungputri() {
    ...
    void frame() {
        ...
        JTextArea area = new JTextArea (" Alamat : Gunung Putri \n Kecamatan : Mekarjaya \n Kabupaten : TarogongKaler \n Jarak Dari Ibu Kota : 9 Km");
        JTextArea area2 = new JTextArea ("98 Ha");
        JTextArea area3 = new JTextArea ("Sudah dilayani oleh angkutan kota jurusan terminal Guntur - Cipanas, tersedianya jalan menuju lokasi destinasi");
        JTextArea area4 = new JTextArea ("Olahraga Paralayang");
        ...
        //label8
        label8.setText("Dikelola oleh Masyarakat");
