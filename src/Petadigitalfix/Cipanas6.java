...
public class Cipanas6 {
    ...
    public void frame( ) {
        ...
        JTextArea area = new JTextArea (" Desa : Pasawahan \n Kecamatan : Tarogong Kaler \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 7 KM ");
        JTextArea area2 = new JTextArea ("�2ha");
        JTextArea area3 = new JTextArea ("dapat diakkses menggunakan kendaraan pribadi dan umum hingga ke kampung dukuh dan dilanjutkan dengan perjalanan kaki.");
        JTextArea area4 = new JTextArea ("Pemandangan Curug.");
        ...
        button1.addActionListener(new java.awt.event.ActionListener() {
            ...
            private void button1ActionPerformed(ActionEvent evt) {
                PetaDigitalTarkal a = new PetaDigitalTarkal();
                a.frame();
                f.dispose();
            }});
