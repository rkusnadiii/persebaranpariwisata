...
public class PuncakParabon extends JFrame {
	
	public PuncakParabon() {
	 ...
	 void frame() {
		...
		JTextArea area = new JTextArea (" Desa : Sukalaksana \n Kecamatan : Samarang \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 20 Km");
		JTextArea area2 = new JTextArea ("±3ha");
		JTextArea area3 = new JTextArea ("Untuk menuju lokasi ini sangatlah mudah karena lokasinya yg dekat dengan jalan raya. Akses menuju lokasi juga sudah bagus, karena jalannya telah terlapisi oleh aspal. Jika dari Garut, untuk menuju Puncak Parabon bisa menuju jalan Samarang, kemudian belok Kanan ke arah kamojang. Lokasinya berada di sebelah kiri dari jalur garut sekitar 8 km dari pertigaan Jalan Kamojang.");
		JTextArea area4 = new JTextArea ("Alam");
		JTextArea area5 = new JTextArea ("Masjid,Toilet,FoodCourt,Tempat Parkir, Warung");
		...
		//label8
				label8.setText("Dikelola oleh Bumdes Bumilaksana ");
