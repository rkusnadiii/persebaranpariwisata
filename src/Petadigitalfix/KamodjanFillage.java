...
public class KamodjanFillage extends JFrame {
	
	public KamodjanFillage() {
	...
	void frame() {
		...
		JTextArea area = new JTextArea (" Desa : Sukakarya \n Kecamatan : Samarang \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 12 Km");
		JTextArea area2 = new JTextArea ("±250 Ha");
		JTextArea area3 = new JTextArea ("Sudah dilayani oleh angkutan kota jurusan terminal Guntur - Samarang, tersedianya jalan menuju lokasi destinasi");
		JTextArea area4 = new JTextArea ("Panorama Alam");
		...
		//label6
				label6.setText("Kamodjan Fillage");
		...
		//label8
				label8.setText("Dikelola oleh BKSDA");
		...
		//label14
				label14.setText("sumber foto: travelingyuk.com");
