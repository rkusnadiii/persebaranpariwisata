...
import Karangpawitan.CurugBatuTulis;
...
public class Cipanas3 {
    ...
    public void frame( ) {
        ...
        JTextArea area = new JTextArea (" Desa : Rancabango \n Kecamatan : Tarogong Kaler \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 4 KM ");
        JTextArea area2 = new JTextArea ("3Ha");
        JTextArea area3 = new JTextArea ("Dapat Diakses oleh Kendaraan Umum maupun Pribadi.");
        JTextArea area4 = new JTextArea ("Kolam Renang Air Panas");
        ...
        //label6
        label6.setText("Kolam Renang Sumber Alam");
        ...
        //label8
        label8.setText("UPTD Dinas Pariwisata dan Kebudayaan");
    ...
    public static void main(String[] args) {
        new Karangpawitan.CurugBatuLempar().frame();
    }
