...
public class DWisdom extends JFrame {
    ...
    void frame() {
        ...
        JTextArea area = new JTextArea (" Desa : Rancabango \n Kecamatan : Tarogong Kaler \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 6,8 Km");
        JTextArea area2 = new JTextArea ("3 Ha");
        JTextArea area3 = new JTextArea ("Untuk mencapai Wisata De Wisdom, kita akan memasuki jalan lokal primer dan pedesaan yaitu desa Rancabango. Lokasi Wisdom tidak jauh dari objek Wisata Cipanas  ada dua alternatif jalan bila langsung naik dari Cipanas ke Naringgul dan memakai jalan pintas ke Rancabango atau melalui arah tarogong. Apabila datang dari arah kota Garut, maka gapura masuk desa berada di sebelah kiri jalan raya. Infrastuktur jalan di Jl  Rancabango cukup baik. Sudah beraspal dan hotmik. Untuk mencapai ke lokasi dapat menggunakan transportasi umum online, andong dan kendaraan pribadi. Jalan pedesaan agak kecil namun cukup untuk dua mobil. Infrastuktur jalan pedesaannya sedikit berlubang. Banyak sawah, pepohonan, dan perkebunan di sepanjang jalan");
        JTextArea area4 = new JTextArea ("Wisata Edukasi domba dan wahana bermain");
        JTextArea area5 = new JTextArea ("Toilet,Mushola,Kedai makan, Pintu Masuk, Gazebo, Parkir");
        ...
        //label8
        label8.setText("Dikelola oleh Husein Mubarok ");
