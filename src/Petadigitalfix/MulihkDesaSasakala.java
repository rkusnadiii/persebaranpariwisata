...
public class MulihkDesaSasakala extends JFrame {
	
	public MulihkDesaSasakala() {
	 ...
	 void frame() {
		...
		JTextArea area = new JTextArea (" Desa : Samarang \n Kecamatan : Samarang \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 11 Km");
		JTextArea area2 = new JTextArea ("±5 Ha");
		JTextArea area3 = new JTextArea ("Mulih K’Desa berjarak 11 Km dari Alun-Alun Kota Garut. Lokasi persisnya ada di Jl. Raya Samarang Kamojang KM 35 Kamojang, Samarang, Kecamatan Samarang. Infrastuktur jalan menuju kesana cukup baik. Untuk mencapai kesana dari Garut kota, perjalanan menempuh waktu sekitar setengah jam.");
		JTextArea area4 = new JTextArea ("Suasana Alam dan Pedesaan");
		JTextArea area5 = new JTextArea ("Mushola,Toilet");
		...
		//label6
				label6.setText("Mulih k Desa Sasakala");
		...
		//label8
				label8.setText("Dikelola oleh Mulih k Desa");
		...
		//label14
				label14.setText("sumber foto: traveloka.com");
