...
public class KebunJerukBosaga extends JFrame {
	
	public KebunJerukBosaga() {
	 ...
	 void frame() {
		...
		//icon2
				...
				//icon6
				ImageIcon icon6 = new ImageIcon("src/Kebun Jeruk Bosaga 3.jpeg");
				Image iconrubah6 = icon6.getImage();
				Image modified6 = iconrubah6.getScaledInstance(400,300,900);
				icon6 = new ImageIcon(modified6);
				//icon7
				ImageIcon icon7 = new ImageIcon("src/Kebun Jeruk Bosaga.jpeg");
		...
		JTextArea area3 = new JTextArea ("Untuk menuju lokasi ini bisa menggunakan angkutan umum jurusan Samarang hingga Ciroyom kemudian menggunakan jasa ojek sejauh -+ 1 km dari jalan raya. Infrastruktur jalan kendaraan baik, beraspal dan Hotmik.");
		JTextArea area4 = new JTextArea ("Kebun");
		JTextArea area5 = new JTextArea ("Warung,Masjid,Toilet,Gazebo");
		...
		//area3
		area3.setFont(new Font("Arial",Font.PLAIN,14));
