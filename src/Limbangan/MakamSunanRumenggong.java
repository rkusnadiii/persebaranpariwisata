...
public class MakamSunanRumenggong {
	
public MakamSunanRumenggong() {
...
JTextArea area = new JTextArea (" Desa : Ciwangi  \n Kecamatan : Limbangan \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 32 KM ");
JTextArea area2 = new JTextArea ("±3ha");
JTextArea area3 = new JTextArea ("Makam Sunan Rumenggong dapat di tempuh dengan kendaraan pribadi yaitu menggunakan kendaraan roda dua sampai ke lokasi");
JTextArea area4 = new JTextArea ("Ziarah makam.");
JTextArea area5 = new JTextArea ("Tempat pembungan sampah");
...
//label6
		label6.setText("Makam Sunan Rumengong");
...
public static void main(String[] args) {
	new MakamSunanRumenggong().frame();
	}
