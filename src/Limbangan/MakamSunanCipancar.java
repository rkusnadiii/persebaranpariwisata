...
public class MakamSunanCipancar {

public MakamSunanCipancar() {
...
JTextArea area = new JTextArea (" Desa : Pasirwaru  \n Kecamatan : Limbangan \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 32 KM ");
JTextArea area2 = new JTextArea ("±1,5 ha");
JTextArea area3 = new JTextArea ("Makam Sunan Rumenggong dapat di tempuh dengan kendaraan pribadi yaitu menggunakan kendaraan roda dua dan roda empat sampai ke lokasi, bisa juga menggunakan ojek lokal");
JTextArea area4 = new JTextArea ("Ziarah makam.");
JTextArea area5 = new JTextArea ("Loket Tiket, Tempat pembungan sampah");
