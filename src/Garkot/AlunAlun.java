...
public class AlunAlun extends JFrame {
    ...
    void frame() {
        ...
        JTextArea area = new JTextArea (" Desa : Desa Paminggir \n Kecamatan : GarutKota \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 0 Km");
        JTextArea area2 = new JTextArea ("70m^2");
        JTextArea area3 = new JTextArea ("Alun-alun Garut merupakan pusat Kota Garut. Letaknya ada di Jl. Ahmad Yani No.22, Paminggir, Kecamatan Garut Kota. Aksesibilitas menuju Alun-alun ini tidak lah sulit karena berada di pusat kota, dilalui oleh beragam tujuan transportasi umum, terdapat di google maps, dan diketahui oleh seluruh masyarakat garut. Bagi wisatawan luar kota yang datang menggunakan bis, anda bisa berhenti di terminal bus kota dan melanjutkan perjalanan ke alun-alun menggunakan ojek, atau angkutan kota.");
        JTextArea area4 = new JTextArea ("Pusat Kota Garut");
        JTextArea area5 = new JTextArea ("Gateway, Area Parkir, Bangku/Kursi, Tempat Sampah");
        ...
        //label6
        label6.setText("Alun ALun Kota Garut");
        ...
        //label8
        label8.setText("Dikelola oleh Pemerintah Garut ");
