...
public class KaracakValley extends JFrame {

    public KaracakValley() {
    ...
    void frame() {
        ...
        JTextArea area = new JTextArea (" Desa : Desa Sukanegla \n Kecamatan : GarutKota \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 9.7 Km");
        JTextArea area2 = new JTextArea ("10ha");
        JTextArea area3 = new JTextArea ("Karacak Valley ini berjarak 9,7km dari Pusat Kota Garut melalu Jl. Raya Garut – Cikajang dan waktu yang ditempuhnya kurang lebih 31 menit. Untuk akses jalannya pun baik, tetapi untuk menuju lokasi wisata sedikit masuk lagi ke pedalaman dan jalannya pun belum terlalu baik.");
        JTextArea area4 = new JTextArea ("Outbond dan Hutan Pinus");
        JTextArea area5 = new JTextArea ("Mushola, Warung Makan, Area Parkir, Gazebo, Area Camping, Toilet");
        ...
        //label8
        label8.setText("Dikelola oleh Lembaga Masyarakat Desa Hutan (LMDH) Jaya Mandiri ");
