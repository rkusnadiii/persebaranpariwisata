...
public class PasarCeplak extends JFrame {
    ...
    void frame() {
        ...
        JTextArea area = new JTextArea (" Desa : Regol \n Kecamatan : GarutKota \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 0 Km");
        JTextArea area2 = new JTextArea ("70m^2");
        JTextArea area3 = new JTextArea ("Pasar Ceplak ini hanya berjarak 1,2 km dari Alun � Alun Garut, dan waktu yang ditempuhnya kurang lebih hanya 6 menit. Untuk akses jalannya pun sangat baik karena termasuk di pusat kota.");
        JTextArea area4 = new JTextArea ("Pusat Jajanan dan Kuliner");
        JTextArea area5 = new JTextArea ("Tempat Kuliner");
