...
public class PeternakanMargawati extends JFrame {

    public PeternakanMargawati() {
    ...
    void frame() {
        ...
        JTextArea area = new JTextArea (" Desa : Sukanegla \n Kecamatan : GarutKota \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 5 Km");
        JTextArea area2 = new JTextArea ("70m^2");
        JTextArea area3 = new JTextArea ("Akses menuju tempat ini agak sulit karena letaknya berada di atas bukit. Jalannya tidak terlalu rusak namun lebar jalanan menuju tempat ini sempit. Dapat diakses melalui angkutan umum seperti angkutan umum cempaka lalu menaiki jasa ojek saat memasuki kawasan pedesaan.");
        JTextArea area4 = new JTextArea ("Wisata Alam dan Edukasi");
        JTextArea area5 = new JTextArea ("Gateway, Area Parkir, Toilet");
        ...
        //label6
        label6.setText("Peternakan Domba Margawati");
