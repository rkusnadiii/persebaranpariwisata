...
public class CentraKulitGarut extends JFrame {

    public CentraKulitGarut() {
    ...
    void frame() {
        ...
        JTextArea area = new JTextArea (" Desa : Kota Wetan \n Kecamatan : GarutKota \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 1 Km");
        JTextArea area2 = new JTextArea ("70m^2");
        JTextArea area3 = new JTextArea ("Aksesnya sangat baik karena berada di pusat kota dan dapat diakses melalui berbagai asal tujuan. Lokasinya pun berada di sepanjang jalan Sukaregang sehingga mudah ditemukan. Sentra Kulit Garut dapat diakses melewati Jl. Ahmad Yani, Jl. Guntur, dan Jl. Ahmad Yani Timur.");
        JTextArea area4 = new JTextArea ("Wisata Belanja");
