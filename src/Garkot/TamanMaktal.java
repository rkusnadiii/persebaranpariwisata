...
public class TamanMaktal extends JFrame {
    ...
    void frame() {
        ...
        JTextArea area3 = new JTextArea ("Taman Maktal berjarak 650m dari Jl.Raya Kadungora Garut, menggunakan kendaraan beroda empat dan menempuh waktu kurang lebih 3-5 menit. Untuk akses jalannya tidak terlalu buruk, karena kita hanya melewati jalan raya saja. ");
        JTextArea area4 = new JTextArea ("Taman dan Spot Foto");
        JTextArea area5 = new JTextArea ("Taman, Kursi Taman, Tempat Sampah");
