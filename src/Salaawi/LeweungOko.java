...
public class LeweungOko extends JFrame {
    ...
    void frame() {
        ...
        JTextArea area = new JTextArea (" Desa : Ciparuhan \n Kecamatan : Selaawi \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 43 Km");
        JTextArea area2 = new JTextArea ("1.5ha");
        JTextArea area3 = new JTextArea ("Pesona Leuweung Oko berjarak 43 km dari pusat Kota Garut. Akses untuk menuju kesana bisa via Leuwigoong atau Wanaraja dan Cibatu kemudian ke Limbangan dan Selaawi dengan waktu tempuh sekitar 1,5 jam menggunakan kendaraan roda dua. Sedangkan waktu tempuh dari pusat Kecamatan Selaawi menuju lokasi adalah sekitar 30 menit. Akses ke lokasi hanya bisa ditempuh dengan kendaraan roda dua dikarenakan jalan yang belum diperlebar.");
        JTextArea area4 = new JTextArea ("Wisata Alam");
        JTextArea area5 = new JTextArea ("Toilet, Saung, Spot Photo, Mushola");
        ...
        //label6
        label6.setText("Pesona Leuweung Oko");
        ...
        //label8
        label8.setText("Dikelola oleh Ikatan Alumni SMPN 1 Selaawi angkatan 95 ");
