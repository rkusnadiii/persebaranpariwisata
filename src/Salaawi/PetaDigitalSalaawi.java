...
public class PetaDigitalSalaawi extends JFrame {

    public PetaDigitalSalaawi() {
    ...
    public void frame() {
        ...
        //icon1
        ImageIcon icon1 = new ImageIcon("src/Selaawi.jpg");
