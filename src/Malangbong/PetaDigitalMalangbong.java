...
public class PetaDigitalMalangbong extends JFrame {
	
		public PetaDigitalMalangbong() {
		...
		JFrame Frame;
		 ...
		 public void frame() {
				...
				//icon1
				ImageIcon icon1 = new ImageIcon("src/Malangbong.jpeg");
...
//label6
		label6.setText("Kecamatan Malangbong");
...
//panel5
		...
		button2.setBounds(540, 103, 10, 10);
		...
		button3.setBounds(500, 103, 10, 10);
		...
		button3.addActionListener(new java.awt.event.ActionListener() {
			...
			private void button3ActionPerformed(ActionEvent evt) {
				KampungParigi a = new KampungParigi();
				a.frame();
				f.dispose();
			}});
		//button4
		...
		button4.setBounds(535, 378, 10, 10);
		...
		button5.setBounds(698, 314, 10, 10);
		...
		button5.addActionListener(new java.awt.event.ActionListener() {
			...
			private void button5ActionPerformed(ActionEvent evt) {
				JSCMalangbong a = new JSCMalangbong();
				a.frame();
				f.dispose();
			}});
	...
	public static void main(String[] args) {
		new PetaDigitalMalangbong().frame();
