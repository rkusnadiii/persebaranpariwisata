...
public class KampungParigi extends JFrame {

    public KampungParigi() {
    ...
    void frame() {
        ...
        JTextArea area = new JTextArea (" Desa : Desa Cilampuyang \n Kecamatan : Malangbong \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 45 Km");
        JTextArea area2 = new JTextArea ("0,2 Ha");
        ...
        JTextArea area4 = new JTextArea ("Mengenal Budaya Khas");
        ...
        //label6
        label6.setText("Kampung Budaya Parigi");
