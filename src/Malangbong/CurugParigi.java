...
public class CurugParigi extends JFrame {
    ...
    void frame() {
        ...
        JTextArea area4 = new JTextArea ("Pemandangan alam Air Terjun");
        JTextArea area5 = new JTextArea ("Toilet, Parkir, Saung");
