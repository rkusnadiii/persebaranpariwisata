...
public class JSCMalangbong extends JFrame {

    public JSCMalangbong() {
    ...
    void frame() {
        ...
        JTextArea area = new JTextArea (" Desa : Desa Cikarang \n Kecamatan : Malangbong \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 45 Km");
        JTextArea area2 = new JTextArea ("-");
        JTextArea area3 = new JTextArea ("Sudah dilayani oleh angkutan Umum jurusan Terminal Malangbong. Infrastruktur kendaraan sampai kota Kecamatan Malangbong baik, namun akses menuju lokasi wisata kurang baik.");
        JTextArea area4 = new JTextArea ("Pemandangan alam, Spot Foto menarik");
        JTextArea area5 = new JTextArea ("Toilet, Parkir, Mushola, Tempat Tiket");
