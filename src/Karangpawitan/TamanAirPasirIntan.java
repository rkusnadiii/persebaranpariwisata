...
public class TamanAirPasirIntan extends JFrame{
	
	public TamanAirPasirIntan () {
	...
	public void frame () {
		//icon
				...
				//icon6
				ImageIcon icon6 = new ImageIcon("src/Taman Air Pasir Intan 1.jpg");
				Image iconrubah6 = icon6.getImage();
				Image modified6 = iconrubah6.getScaledInstance(400,300,900);
				icon6 = new ImageIcon(modified6);
				//icon7
				ImageIcon icon7 = new ImageIcon("src/Taman Air Pasir Intan 3.jpg");
				...
				JTextArea area = new JTextArea (" Desa : Sindanggalih \n Kecamatan : Karangpawitan \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 9,4 KM ");
				JTextArea area2 = new JTextArea ("-");
				JTextArea area3 = new JTextArea ("Taman Air Pasir Intan berjarak 9,4 km dari Jl.Raya Garut, jika kita mengambil jalan via Cikajang waktu tempuhnya kurang lebih 31 menit menggunakan mobil. Untuk akses jalannya tidak terlalu buruk, karena kita hanya melewati jalan raya saja. Tetapi untuk menuju lokasi taman airnya, agak sedikit bermasalah jika menggunakan mobil, karena kita harus memasuki jalan pemukiman warga yang seadanya. ");
				JTextArea area4 = new JTextArea ("Taman Air");
				JTextArea area5 = new JTextArea ("Castle Gazebo, Perosotan, Ember Tumpah, Toilet");
				...
				//frame
						...
						//label6
								label6.setText("Taman Air Pasir Intan");
						...
						//label8
								label8.setText("Swasta (Muhammad Sidiq)");
						...
						//label14
								label14.setText("Tiket Masuk : 10.000/orang");
