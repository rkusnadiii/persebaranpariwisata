...
import Limbangan.MakamSunanRumenggong;
...
public class PetaDigitalKarangpawitan extends JFrame {
	
	public PetaDigitalKarangpawitan() {
	...
	public void frame () {
		...
		//icon
				...
				//icon1
				ImageIcon icon1 = new ImageIcon("src/Karangpawitan1.png");
				...
				button2.setBounds(626, 543, 10, 10);
				...
				button3.setBounds(620, 520, 10, 10);
				...
				button4.setBounds(715, 522, 10, 10);
				...
				button4.addActionListener(new java.awt.event.ActionListener() {
					...
					private void button4ActionPerformed(ActionEvent evt) {
						CurugBatuSusun a = new CurugBatuSusun();
						a.frame();
						f.dispose();
					}});
				//button5
				...
				button5.setBounds(725, 444, 10, 10);
				...
				button6.setBounds(614, 258, 10, 10);
				...
				button6.addActionListener(new java.awt.event.ActionListener() {
					...
					private void button6ActionPerformed(ActionEvent evt) {
						SituCibalagung a = new SituCibalagung();
						a.frame();
						f.dispose();
					}});
				//button7
				...
				button7.setBounds(508, 293, 10, 10);
				...
				button8.setBounds(595, 322, 10, 10);
				...
				button8.addActionListener(new java.awt.event.ActionListener() {
					...
					private void button8ActionPerformed(ActionEvent evt) {
						 TamanAirPasirIntan a = new TamanAirPasirIntan();
						a.frame();
						f.dispose();
					}});
				//panel1
				...
				//label6
						label6.setText("Kecamatan Karangpawitan");
	...
	public static void main(String[] args) {
		new PetaDigitalKarangpawitan().frame();
