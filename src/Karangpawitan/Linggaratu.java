...
public class Linggaratu extends JFrame {
	...
	public void frame () {
		//icon
				...
				JTextArea area = new JTextArea (" Desa : Sindangpalay \n Kecamatan : Karangpawitan \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 11,2 KM ");
				JTextArea area2 = new JTextArea ("±1,5ha");
				JTextArea area3 = new JTextArea ("Dari Jl. Raya Garut, jika kita mengambil jalan via Sukaregang waktu tempuhnya kurang lebih 45 menit menggunakan mobil. Untuk akses jalan raya tidak terlalu buruk, namun saat mulai memasuki pedesaan jalan agak rusak dan jalannya menanjak.");
				JTextArea area4 = new JTextArea ("Makam, Bebatuan");
				JTextArea area5 = new JTextArea ("Toilet, Warung, Area Camping, Tempat ibadah");
				...
				//frame
						...
						//label8
								label8.setText("Dikelola Oleh Masyarakat Lokal(Asep Linggaratu)");
