...
public class MakamGodog extends JFrame{
	...
	public void frame () {
		...
		JTextArea area = new JTextArea (" Desa : LebakAgung \n Kecamatan : Karangpawitan \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 14 KM ");
		JTextArea area2 = new JTextArea ("±1,5ha");
		JTextArea area3 = new JTextArea ("Akses meuju lokasi sudah sangat baik, dapat ditempuh dengan kendaraan roda 2 maupun roda 4. Kompleks makam ini dapat ditempuh melalui angkutan kota trayek Terminal Guntur–Sukawening atau angkutan kota Terminal Guntur–Karangpawitan sampai ke jalan akses kompleks . Perjalanan ke kompleks makam Keramat Godog dapat juga  dicapai dengan ojeg dari terminal Guntur. Jalan akses tersebut berjarak kurang lebih 4 km, dan dilanjutkan dengan  footpath berupa tangga yang memiliki 53 buah anak tangga.");
		JTextArea area4 = new JTextArea ("Makam");
		JTextArea area5 = new JTextArea ("Kios, toilet, mushola dan toilet.");
		...
		//frame
				...
				//label8
						label8.setText("Dikelola oleh Pemerintah Daerah");
				...
				//label15
						label15.setText("sumber foto: garuttrip.com");
						label15.setFont(new Font("Arial",Font.PLAIN,12));
						label15.setForeground(new Color(242,110,1));
						label15.setBounds(310,380 ,400, 70);
