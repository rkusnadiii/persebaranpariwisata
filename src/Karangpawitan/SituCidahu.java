...
public class SituCidahu extends JFrame {
	...
	public void frame () {
		...
		JTextArea area = new JTextArea (" Desa : Karangmulya \n Kecamatan : Karangpawitan \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 8 KM ");
		JTextArea area2 = new JTextArea ("-");
		JTextArea area3 = new JTextArea ("Kondisi jalan menuju objek cukup memadai, namun untuk sampai ke lokasi  hanya dapat menggunakan kendaraan roda dua. Untuk mencapai ke lokasi dapat digunakan sarana transportasi berupa angkutan umum nomor 12/ 07 jurusan wanaraja bisa berhenti di Jl Cibangban Setelah itu untuk menuju lokasi yang berjarak 2 km dapat menggunakan  kendaraan Roda 4 atau angkutan roda dua berupa ojeg.");
		JTextArea area4 = new JTextArea ("Danau");
		JTextArea area5 = new JTextArea ("Warung, Toilet, Mushola");
		...
		//frame
				...
				//label8
						label8.setText("Dikelola Oleh Desa Karangmulya");
