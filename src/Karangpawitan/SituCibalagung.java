...
public class SituCibalagung extends JFrame {
	
	public SituCibalagung () {
	...
	public void frame () {
		...
		JTextArea area = new JTextArea (" Desa : Cimurah \n Kecamatan : Karangpawitan \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 8,3 KM ");
		JTextArea area2 = new JTextArea ("-");
		JTextArea area3 = new JTextArea ("Situ Cibalagung berjarak 8,3 Km dari Alun-Alun Kota Garut apabila mengambil akses melewati Jl. Ahmad Yani dan Jl. Karangpawitan dengan waktu tempuh kurang lebih 27 menit menggunakan mobil. Untuk mencapai Situ, pengunjung diharuskan berjalan kaki kurang lebih 500m karena akses yang tidak bisa dilalui oleh kendaraan. Untuk menuju situ, pengunjung harus melewati pemukiman atau perkampungan warga kemudian melalui jalan setapak ");
		JTextArea area4 = new JTextArea ("Kolam");
		JTextArea area5 = new JTextArea ("Toilet, Gazebo");
		...
		//frame
				...
				//label6
						label6.setText("Situ Cibalagung");
				...
				//label8
						label8.setText("Dikelola Oleh Masyarakat Lokal(Pak Nandang)");
