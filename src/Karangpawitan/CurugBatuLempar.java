...
public class CurugBatuLempar {
	
	
	public CurugBatuLempar() {
	...
	public void frame( ) {
		...
		JTextArea area = new JTextArea (" Desa : Kampung Godog \n Kecamatan : Karangpawitan \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 9,9 KM ");
		JTextArea area2 = new JTextArea ("±2ha");
		JTextArea area3 = new JTextArea ("Wisata Alam Batu Lempar dapat ditempuh menggunakan kendaraan pribadi. Akses untuk menuju Wisata Alam Batu Lempar melalui Jalan Cempaka dengan arah menuju Godog. Waktu tempuh untuk menuju Wisata Alam Batu Lempar yaitu 32 menit (dari Alun-Alun Garut). Kondisi jalan sangat baik, namun akses jalan desa masih butuh perbaikan.");
		JTextArea area4 = new JTextArea ("Aliran sungai, hutan pinus, camp ground dan trail.");
		JTextArea area5 = new JTextArea ("Warung, tempat sampah, gazebo, tempat parkir dan toilet.");
		...
		//frame
				...
				//button2
				button2.setBounds(1150, 590, 100, 50);
				...
				button2.addActionListener(new java.awt.event.ActionListener() {
					...
					private void button1ActionPerformed(ActionEvent evt) {
						CurugBatuTulis a = new CurugBatuTulis();
						a.frame();
						f.dispose();
					}});
				...
				//label6
						label6.setText("Curug Batu Lempar");
				...
				//label8
						label8.setText("Masyarakat Lokal (Pak Apar)");
