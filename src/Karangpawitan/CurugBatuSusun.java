...
public class CurugBatuSusun extends JFrame {
	
	public CurugBatuSusun () {
	...
	public void frame () {
		//icon
				...
				JTextArea area = new JTextArea (" Desa : Kampung Godog \n Kecamatan : Karangpawitan \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 10,2 KM ");
				JTextArea area2 = new JTextArea ("±3ha");
				JTextArea area3 = new JTextArea ("Curug Batu Susun dapat ditempuh menggunakan kendaraan pribadi. Akses untuk menuju Curug Batu Susun melalui Jalan Cempaka dengan arah menuju Godog. Waktu tempuh untuk menuju Curug Batu Susun yaitu 34 menit (dari Alun-Alun Garut). Kondisi jalan sangat baik, namun akses jalan desa masih butuh perbaikan.");
				JTextArea area4 = new JTextArea ("Air terjun dan jalur trail.");
				JTextArea area5 = new JTextArea ("Gazebo, tempat sampah, jembatan, mushola dan toilet.");
				...
				//frame
						...
						//label6
								label6.setText("Curug Batu Susun");
						...
						//label8
								label8.setText("Dikelola Oleh Masyarakat Lokal (Pak Enjang)");
