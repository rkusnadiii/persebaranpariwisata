...
public class CurugBatuTulis extends JFrame {
	
	public CurugBatuTulis () {
	...
	public void frame () {
		...
		//icon
				...
				JTextArea area4 = new JTextArea ("Air terjun, corak tulisan pada batu besar dan hutan pinus");
				JTextArea area5 = new JTextArea ("Gazebo dan tempat sampah.");
				...
				//frame
						...
						button1.addActionListener(new java.awt.event.ActionListener() {
							...
							private void button1ActionPerformed(ActionEvent evt) {
								CurugBatuLempar a = new CurugBatuLempar();
								a.frame();
								f.dispose();
							}});
						...
						//label6
								label6.setText("Curug Batu Tulis");
