...
public class MakamDjafar extends JFrame {
    ...
    void frame() {
        ...
        JTextArea area = new JTextArea (" Desa : Cipareuan \n Kecamatan : Cibiuk \n Kabupaten : Garut \n Jarak Dari Ibu Kota : 15,1 Km");
        JTextArea area2 = new JTextArea ("70m^2");
        JTextArea area3 = new JTextArea ("Dari Jl. Raya Garut, jika kita mengambil jalan via Banyuresmi waktu tempuhnya kurang lebih 40 menit menggunakan mobil. Untuk akses jalan raya sangat baik karena melewati jalan raya sepanjang jalan hingga destinasi wisata. ");
        JTextArea area4 = new JTextArea ("Wisata Religi");
        JTextArea area5 = new JTextArea ("Toilet, Warung Cenderamata, Parkir, Masjid");
